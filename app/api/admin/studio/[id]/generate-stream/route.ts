...
export async function POST(
  ...
  try {
    ...
    steps = body.steps || ["transcript", "episode_intelligence", "ai_output", "chapters", "clips", "website_package", "deep_analysis", "guest_intelligence"]
    forceRegenerate = body.force === true
  } catch {
    steps = ["transcript", "episode_intelligence", "ai_output", "chapters", "clips", "website_package", "deep_analysis", "guest_intelligence"]
  }
