...
## مخطط JSON المطلوب:
{
  ...
  "guest_name": "اسم الضيف الكامل أو null",
    ...
    return {
      ...
      data: {
        ...
        timestamps: Array.isArray(parsed.timestamps)
          ...
          : [],
        guest_name: typeof parsed.guest_name === "string" ? parsed.guest_name : null,
        guest_bio: typeof parsed.guest_bio === "string" ? parsed.guest_bio : null,
      },
      raw: { model: response.model, usage: response.usage, response_id: response.id },
    }
  } catch (error) {
